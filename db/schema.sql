...
-- Cada fila es únicamente un timestamp más país/ciudad aproximados: sin IP,
-- sin user-agent, sin identificador de usuario. País/ciudad vienen de los
-- metadatos que Cloudflare ya adjunta a cada request (no de guardar la IP).
-- country/city agregados 19 ago 2026 — en bases ya existentes (prod/staging)
-- requieren ALTER TABLE manual, ver nota de migración abajo.
-- ============================================================
